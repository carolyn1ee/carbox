...
Then click the "done drawing roads" button to go to the next simulation. Please wait a good amount of time to let some cars go through the simulation before moving onto the next simulation. At least one car should exit the screen before you try to go onto the next simulation.
